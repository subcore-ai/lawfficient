...
| `POST` | [`/api/leads`](/docs/leads/push) | `leads:write` | Create a lead |
| `PATCH` | [`/api/leads/{id}`](/docs/leads/update) | `leads:write` | Update a lead (partial) |
| `POST` | [`/api/leads/{id}/archive`](/docs/leads/archive) | `leads:write` | Archive a lead |
| `POST` | [`/api/leads/{id}/unarchive`](/docs/leads/archive) | `leads:write` | Restore a lead |
